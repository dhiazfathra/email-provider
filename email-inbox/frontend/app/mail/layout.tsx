...
function MailShell({ children }: { children: React.ReactNode }) {
  const { theme, isDesktop, railCollapsed, toggleRail } = useMail();
      ...
      <div
        style={{
          ...
          gridTemplateColumns: railCollapsed
            ...
            : "var(--mail-shell-cols)",
          height: "100%",
          padding: "var(--mail-shell-pad)",
          gap: "var(--mail-shell-gap)",
        }}
      >
        <aside
          style={{
            display: "var(--mail-rail-display)",
        ...
        <main
          style={{
            ...
            display: "flex",
            flexDirection: "column",
            gap: "var(--mail-main-gap)",
            minWidth: 0,
            paddingBottom: "var(--mail-main-pb)",
          }}
        >
          <header
            style={{
              display: "flex",
              alignItems: "center",
              gap: "var(--mail-head-gap)",
              padding: "var(--mail-head-pad)",
              borderRadius: 22,
              background: theme.glass,
              backdropFilter: "blur(26px)",
              WebkitBackdropFilter: "blur(26px)",
          ...
          <div
            style={{
              display: "var(--mail-chips-display)",
              gap: 7,
              overflowX: "auto",
              paddingBottom: 2,
              flex: "none",
          ...
          <nav
            style={{
              ...
              bottom: 0,
              zIndex: 6,
              display: "var(--mail-bottom-display)",
              alignItems: "center",
              gap: 6,
              padding: "10px 12px",
              borderRadius: 20,
